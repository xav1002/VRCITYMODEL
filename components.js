...
AFRAME.registerComponent('ios-controller', {
    ...
    updatePosition: function() {
        ...
        this.el.object3D.parent.el.object3D.position.x = this.el.object3D.position.x;
        this.el.object3D.parent.el.object3D.position.y = this.el.object3D.position.y;
        this.el.object3D.parent.el.object3D.position.z = this.el.object3D.position.z;
        console.log(this.el.object3D.parent.el.object3D.position);
        if(game.moveForward) {
